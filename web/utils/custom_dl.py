...
async def generate_file_properties(self, id: int) -> FileId:
    """
    Generates the properties of a media file.
    """
...
async def generate_media_session(self, client: Client, file_id: FileId) -> Session:
    ...
    Required for streaming bytes from Telegram servers.
    """
...
async def clean_cache(self) -> None:
    """
    Periodically clears the file ID cache to reduce memory usage.
    """
    while True:
